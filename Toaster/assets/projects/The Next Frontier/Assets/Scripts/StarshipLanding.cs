...
namespace TheNextFrontier
{
    ...
    {   	
        ...
        void OnCreate()
        {
            ...
            mVelocityEntity = mStarshipInfoPanel.FindDecententByName(mStarshipInfoPanel.ID, "VelocityValueText");
            mAltitudeEntity = mStarshipInfoPanel.FindDecententByName(mStarshipInfoPanel.ID, "AltitudeValueText");
        ...
        void OnUpdate(float ts)
        {
            ...
            if (mPanel.Visible)
            {
                ...
                if (mTotalTime > 0.15f)
                {
                    ...
                    mVelocityText.Text = $"{linearVelocity:F1} m/s";
                    mAltitudeText.Text = $"{altitude:F1} m";
                }
