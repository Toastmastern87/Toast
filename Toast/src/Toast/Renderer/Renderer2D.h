...
namespace Toast {
	...
	public:
		...
		static void DrawRotatedQuad(const DirectX::XMMATRIX& transform, const DirectX::XMFLOAT4& color);
		static void DrawRotatedQuad(const DirectX::XMMATRIX& transform, const Ref<Texture2D>& texture, const float tilingFactor = 1.0f, const DirectX::XMFLOAT4& tintColor = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
